...
test_image_path = "example_data/CytAssist_FFPE_Human_Breast_Cancer_tissue_image.tif"
...
#model = RedeHist.RedeHist_model.load_from_checkpoint(model_path, sc_data = sc_data_use, max_cell = max_cell, mode='mapping', device = device, strict=False)
model.to(device)
